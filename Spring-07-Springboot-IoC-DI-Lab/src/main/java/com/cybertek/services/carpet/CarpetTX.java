...
@Component
public class CarpetTX implements Carper {
    private static  final Map<City,BigDecimal> sqPriceForCity = new HashMap<>();

    static{
        sqPriceForCity.put(City.AUSTIN, new BigDecimal("2.32"));
        sqPriceForCity.put(City.DULLES, new BigDecimal("3.50"));
        sqPriceForCity.put(City.SAN_ANTONIO, new BigDecimal("3.30"));
    }
